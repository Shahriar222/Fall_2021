...
{
    $validatecheckbox="";
    if(isset($_REQUEST["Junior Programmer"]))
    {
        $v1= $_REQUEST["Junior Programmer"];
        $validatecheckbox=$validatecheckbox.$v1;
    }
    if(isset($_REQUEST["Senior Programmer"]))
    { 
        $v2= $_REQUEST["Senior Programmer"];
        $validatecheckbox=$validatecheckbox.",".$v2;
    }
    if(isset($_REQUEST["Project Lead"]))
    {
     $v3= $_REQUEST["Project Lead"];
